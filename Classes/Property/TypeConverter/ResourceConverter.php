<?php
namespace Webfox\Placements\Property\TypeConverter;
...
class ResourceConverter extends AbstractTypeConverter {
	...
	protected function importUploadedResource(array $uploadInfo, PropertyMappingConfigurationInterface $configuration) {
		...
		$allowedFileExtensions = $configuration->getConfigurationValue('Webfox\\Placements\\Property\\TypeConverter\\ResourceConverter', self::CONFIGURATION_ALLOWED_FILE_EXTENSIONS);
		...
		$uploadFolderId = $configuration->getConfigurationValue('Webfox\\Placements\\Property\\TypeConverter\\ResourceConverter', self::CONFIGURATION_UPLOAD_FOLDER) ?: $this->defaultUploadFolder;
		$conflictMode = $configuration->getConfigurationValue('Webfox\\Placements\\Property\\TypeConverter\\ResourceConverter', self::CONFIGURATION_UPLOAD_CONFLICT_MODE) ?: $this->defaultConflictMode;
